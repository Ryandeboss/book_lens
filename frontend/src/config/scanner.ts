...
export const scannerConfig = {
  ...
  angleMinOppositeRatio: 0.6, // Allow more handheld perspective before blocking.
  angleMaxCornerCosine: 0.5, // About 30 degrees of projected corner skew, not camera tilt.
  angleMinShapeRatio: 0.35, // Still reject severe foreshortening.
  angleMinTextRows: 6,
  angleMinTextScaleRatio: 0.58,
  angleMaxTextDivergence: 11, // Degrees between near/far printed lines, not camera roll.
